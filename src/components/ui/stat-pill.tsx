  ...
  return (
    <span
      ...
      className={cn(
        ...
        layout === "stacked" &&
          "min-w-0 flex-col justify-center gap-1.5 rounded-control px-2 py-3 text-center text-xs",
    ...
    >
      {layout === "stacked" ? (
        <>
          ...
          {value !== undefined ? (
            <strong className="text-xl leading-none font-black tabular-nums">
              {value}
            </strong>
          ) : null}
        </>
        ...
        <>
          ...
          <span>{label}</span>
          {value !== undefined ? (
            <strong className="font-black tabular-nums">{value}</strong>
          ) : null}
        </>
      )}
    </span>
